...
#pragma link C++ class RegularGrid3D < double, 65, 65, 90> + ;
#pragma link C++ class DataContainer3D < double, 65, 65, 90> + ;
#pragma link C++ class O2TPCPoissonSolver < double, 65, 65, 90> + ;

#pragma link C++ class RegularGrid3D < double, 65, 65, 180> + ;
#pragma link C++ class DataContainer3D < double, 65, 65, 180> + ;
#pragma link C++ class O2TPCPoissonSolver < double, 65, 65, 180> + ;

#pragma link C++ class RegularGrid3D < double, 257, 257, 360> + ;
#pragma link C++ class DataContainer3D < double, 257, 257, 360> + ;
#pragma link C++ class O2TPCPoissonSolver < double, 257, 257, 360> + ;

#pragma link C++ class RegularGrid3D < double, 129, 129, 360> + ;
#pragma link C++ class DataContainer3D < double, 129, 129, 360> + ;
#pragma link C++ class O2TPCPoissonSolver < double, 129, 129, 360> + ;
